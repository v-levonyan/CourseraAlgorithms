package algorithms; /******************************************************************************
 *  Compilation:  javac algorithms.StdIn.java
 *  Execution:    java algorithms.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code algorithms.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code algorithms.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">algorithms.StdIn.java</a>
 ...
 *  <pre>
 *  while (!algorithms.StdIn.isEmpty()) {
 *      double value = algorithms.StdIn.readDouble();
 *      algorithms.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = algorithms.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 ...
 *       and sockets.
 *  <li> {@code algorithms.StdIn} uses whitespace as the delimiter pattern
 ...
 *  If the input begins with the optional byte-order mask, {@code algorithms.StdIn}
